   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="product-layout">
            ...
            <div class="product-details">
                <!-- Inputs for product update -->
                <label>Update name</label>
                <input type="text" placeholder="enter product name" name="name" value="<?= $fetch_products['name']; ?>" class="box">
                <label>Update price</label>
                <input type="number" placeholder="enter product price" name="price" class="box" value="<?= $fetch_products['price']; ?>">
                <label>Update description</label>
                <input type="text" placeholder="enter product description" name="description" class="box" value="<?= $fetch_products['description']; ?>">
